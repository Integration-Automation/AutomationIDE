...
from integration_testing_environment.integration_testing_environment_ui. \
    api_testka_menu.build_api_testka_menu import set_apitestka_menu
from integration_testing_environment.integration_testing_environment_ui. \
    auto_control_menu.build_autocontrol_menu import set_autocontrol_menu
from integration_testing_environment.integration_testing_environment_ui.\
    load_density_menu.build_load_density_menu import set_load_density_menu
from integration_testing_environment.integration_testing_environment_ui.web_runner_menu.build_webrunner_menu import \
    set_web_runner_menu
